...
\noindent We remark that the exit time is higher with a high value of stochastic diffusion. On the other hand, results stabilize for small values of $\sigma$.
